    ...
    <nav
      ...
      <div
        ...
        <div class="navbar-start is-uppercase has-text-weight-semibold">
          ...
          <nuxt-link
            :to="localePath({ name:'collection-slug', params: { collection: 'category', slug: 'fake-news-5da707da6ae80e607432d6b8', type: null } })"
            class="navbar-item">
            {{ $t('header.fake_news') }}
          </nuxt-link>
          <nuxt-link
            :to="localePath({ name:'collection-slug', params: { collection: 'category', slug: 'videos-5da707da6ae80e607432d6b7', type: null }})"
